...
./bombardier -d 10s --fasthttp http://localhost:3002/ --print result >> ./results/results.node.txt
...
./bombardier -d 10s --fasthttp http://localhost:3001/ --print result >> ./results/results.node.txt
